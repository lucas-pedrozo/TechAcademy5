...
import Backgroud from "../../assets/ImageBg/BG3.png";
...
function Register() {
  ...
  return (
    <>
      <Layout backgroundImage={Backgroud}>
        ...
        "
          ...
          "
            >
              ...
              <form action="" className="flex flex-col gap-[20px]   ">
                ...
                />
                <div className="flex justify-end pt-[10px] pl-[20px] pr-[10px] ">
                  <button
                    type="submit"
          ...
          <div
            className="mt-[40px] bg-[rgba(255,255,255,0.2)] backdrop-blur-xl border-[1px] border-white rounded-3xl
          p-[20px] max-w-[580px] m-auto
          ...
          >
            <div className="flex items-center">
              ...
              <label
                ...
                className="w-5 h-5 rounded-full  border-white border-[2px] flex items-center justify-center cursor-pointer"
              >
                {checked && (
                  <div className="w-3.5 h-3.5 bg-black border-[1px] border-white rounded-full" />
                )}
              </label>
              <label
                htmlFor="policyCheckbox"
                className="text-[14px] pl-[5px] cursor-pointer"
              >
                Read the policy terms and features of our system,
