...
function Home() {
  const [motionBanner1, setMotionBanner1] = useState<string | null>(null);
  const [motionBanner2, setMotionBanner2] = useState<string | null>(null);

  useEffect(() => {
    import("../../assets/videos/MotionBanner1.mp4").then((module) => setMotionBanner1(module.default));
    import("../../assets/videos/MotionBanner2.mp4").then((module) => setMotionBanner2(module.default));
  }, []);
