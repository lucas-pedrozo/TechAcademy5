...
export default function Login() {
  return (
    <Layout backgroundImage={BG}>
      <section className="pt-[2.5em] px-[0.625em]">
        <div
          className="bg-[rgba(255,255,255,0.2)] backdrop-blur-xl border-[1px] border-white p-[10px] max-w-[420px]  min-[880px]:max-w-[860px] m-auto rounded-[20px] flex items-center gap-[20px] overflow-hidden
        ...
        >
          <img
            src={imagemLogin}
            alt="imagem login"
            className="rounded-[20px] hidden min-[880px]:block
          ...
          >
            ...
            <form action="" className="flex flex-col gap-[20px]   ">
              <input
                ...
                title="email"
                placeholder="E-mail"
                className="px-[20px] w-full h-[40px] rounded-[40px] text-[rgba(0,0,0,0.8)] font-medium bg-[rgba(255,255,255,0.2)] border-[1px] border-white placeholder:text-[rgba(0,0,0,0.8)] placeholder:text-[1rem] placeholder:font-medium placeholder:tracking-wide focus:outline-none focus:border-white "
              />
              <input
                type="password"
                id="password"
                ...
                title="password"
                className="px-[20px] w-full h-[40px] rounded-[40px] text-[rgba(0,0,0,0.8)]  bg-[rgba(255,255,255,0.2)] border-[1px] border-white placeholder:text-[rgba(0,0,0,0.8)] placeholder:text-[1rem] placeholder:font-medium placeholder:tracking-wide focus:outline-none focus:border-white "
              />
